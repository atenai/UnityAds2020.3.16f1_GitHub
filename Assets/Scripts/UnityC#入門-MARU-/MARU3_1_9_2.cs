...
public class MARU3_1_9_2 : MonoBehaviour
{
    /// <summary>
    /// スライムクラス
    /// </summary> 
    ...
    void Start()
    {
        ...
        //ファイアスライム
        Slime fireSlime = new Slime("ファイアスライム");
        //ファイアスライムデータ割り当て
        fireSlime.Hp = 80;
        ...
        //アイススライム
        Slime iceSlime = new Slime("アイススライム") { Hp = 120, AttackPower = 50, DefensePower = 60 };

        //エレキスライム
        Slime electricSlime = new Slime("エレキスライム")
        {
            //エレキスライムデータ割り当て
            Hp = 100,
            AttackPower = 80,
