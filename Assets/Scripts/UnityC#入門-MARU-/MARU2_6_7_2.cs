...
public class MARU2_6_7_2 : MonoBehaviour
{
    void Start()
    {
        //Debug.Log("Start関数呼び出し");

        Debug.Log(PlayerPrefs.GetInt("AB", 0));
        Debug.Log(PlayerPrefs.GetFloat("CD", 0.0f));
        Debug.Log(PlayerPrefs.GetString("EF", "セーブデータがありません"));
    }
