...
public class MARU3_1_8_1 : MonoBehaviour
{
    /// <summary>
    /// スライムクラス
    /// </summary> 
    public class Slime
    {
        ...
        public Slime(string name, int hp, int attackPower, int defensePower)
        {
            ...
            Debug.Log(name + "のhp = " + this.hp);
            Debug.Log(attackPower + "のattackPower = " + this.attackPower);
            Debug.Log(defensePower + "のdefensePower = " + this.defensePower);
        }
