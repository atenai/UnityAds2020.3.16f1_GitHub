...
public class MARU3_1_8_2 : MonoBehaviour
{
    /// <summary>
    /// スライムクラス
    /// </summary> 
    public class Slime
    {
        ...
        //コンストラクタ
        public Slime(string name, int hp, int attackPower, int defensePower)
        {
            _hp = hp;
            _attackPower = attackPower;
            _defensePower = defensePower;

            Debug.Log(name + "のhp = " + _hp);
            Debug.Log(attackPower + "のattackPower = " + _attackPower);
            Debug.Log(defensePower + "のdefensePower = " + _defensePower);
        }
